...
function Searchbar({ setSearch }) {
  ...
  return (
    <div className="flex justify-center mt-6 px-4">
      <div className="flex items-center bg-white shadow-lg rounded-full px-4 md:px-6 py-3 w-full max-w-[850px]">
        ...
        <button
          ...
          className="ml-3 md:ml-4 bg-red-500 text-white rounded-full p-3"
        >
          🔍
        </button>
